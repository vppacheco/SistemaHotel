...
public class freserva {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "IdHabitacion", "Numero Habitacion", "idcliente", "Cliente", "idtrabajador", "Trabajador", "Tipo Reserva", "Fecha de la Reserva", "Fecha de Ingreso", "Fecha de la Salida", "Costo", "Estado"};
        ...
        sSQL = "Select r.idreserva,r.idhabitacion,h.numero,r.idcliente,"
                ...
                + " r.costo_alojamiento,r.estado from reserva r inner join habitacion h on r.idhabitacion = h.idhabitacion where r.fecha_reserva like'%" + buscar + "%' order by idreserva";
    ...
    public boolean editar(vreserva dts) {
        ...
        sSQL = "update reserva set idhabitacion = ?, idcliente = ? "
                + ", idtrabajador = ? ,tipo_reserva = ? , fecha_reserva = ? ,fecha_ingresa = ?,fecha_salida = ? ,costo_alojamiento = ?, estado= ? where idreserva = ?";
