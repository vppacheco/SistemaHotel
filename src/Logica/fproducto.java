...
public class fproducto {
    ...
    public DefaultTableModel mostrar(String buscar){
        ...
        String [] titulos = {"ID", "Producto","Descripcion","Unidad de Mediad","Precio de Venta"} ; 
    ...
    public boolean insertar (vproducto dts){
        ...
        try {
            ...
            pst.setString(3, dts.getUnidad_mediad());
    ...
    public boolean editar (vproducto dts){
         ...
         sSQL = "update producto set nombre = ?, descripcion = ? " +
