...
public class ftrabajador {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Nombre", "APaterno", "AMaterno", "Doc", "Num Doc", "Direccion", "Telefono", "Email", "Sueldo", "Acceso", "Login", "Clave", "Estado"};
    ...
    public boolean insertar(vtrabajador dts) {
        ...
        try {
            ...
            pst2.setString(4, dts.getPasswords());
    ...
    public boolean editar(vtrabajador dts) {
        ...
        sSQL = "update persona set nombre = ?, apaterno = ? "
                + ", amaterno = ? ,tipo_documento = ? , num_documento = ? ,direccion = ? , telefono = ? ,email = ? where idpersona = ?";
    ...
    public DefaultTableModel login(String login,String password) {
        ...
        sSQL = "Select p.idpersona,p.nombre,p.apaterno,p.amaterno,t.acceso,t.login,t.password,t.estado from persona p inner join trabajador t "
